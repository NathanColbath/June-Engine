...
public class ImGuiLayer {
    ...
    private boolean dockspaceEnabled = false;
    ...
    public ImGuiLayer(long glfwWindow, Window window) {
    ...
    private ArrayList<ImGuiFactory> factories = new ArrayList<>();
...
//        ImGuiFreeType.buildFontAtlas(fontAtlas, ImGuiFreeType.RasterizerFlags.LightHinting);
    ...
    public void update(float dt) {
        EngineServices.imGuiLayer().startFrame(dt);
        ...
        for(ImGuiFactory factory : factories){
            factory.onImGui();
        }

        ImGui.render();

        EngineServices.imGuiLayer().endFrame();
    }
    ...
    public void addFactory(ImGuiFactory factory) {
        factories.add(factory);
    }

    public void removeFactory(ImGuiFactory factory) {
        factories.remove(factory);
    }


    public void enableDockspace(){
